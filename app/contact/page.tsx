            ...
            >
              <div className="mb-12">
                <div className="w-32 h-32 mx-auto lg:mx-0 mb-6 bg-gradient-to-br from-purple-600 to-blue-600 rounded-full flex items-center justify-center overflow-hidden">
                  <img src="/me.jpeg" alt="John Doe" className="w-28 h-28 object-cover rounded-full" />
                </div>
                <h2 className="text-3xl font-black mb-2">Mohamed Maher</h2>
                <p className="text-purple-300 text-lg">PHP & Laravel Backend Developer</p>
              </div>
              ...
              <div className="space-y-6">
                ...
                >
                  ...
                  <div>
                    ...
                    <p className="text-purple-200">m7mdellham77@gmail.com</p>
                  </div>
                </motion.div>
                ...
                >
                  ...
                  <div>
                    ...
                    <p className="text-purple-200">+201024328382</p>
                  </div>
                </motion.div>
                ...
                >
                  ...
                  <div>
                    ...
                    <p className="text-purple-200">Mansoura, Egypt</p>
                  </div>
                </motion.div>
              </div>
              ...
              <div className="pt-8">
                ...
                <div className="flex gap-4">
                  ...
                  <motion.a
                    href="mailto:m7mdellham77@gmail.com"
                    target="_blank"
                  ...
                  <motion.a
                    href="https://www.linkedin.com/in/mohamed-maher-tawfik/" target="_blank"
